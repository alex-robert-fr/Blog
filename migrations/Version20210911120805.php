 ...
 */
final class Version20210911120805 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire CHANGE article article_id_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire CHANGE article_id_id article INT NOT NULL');
    }
}
